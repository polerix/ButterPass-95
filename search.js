...
function renderDirectResult(videoId, originalInput) {
    searchResults.innerHTML = `
        <div class="placeholder-text" style="margin-bottom: 10px;">Direct Link Detected:</div>
        <div class="search-result-item">
            <div class="result-thumb-container">
                <img class="result-thumb" src="https://img.youtube.com/vi/${videoId}/mqdefault.jpg" alt="thumb">
            </div>
            <div class="result-info">
                <div class="search-result-title">Direct Video (${videoId})</div>
                <div class="result-channel">Manual Entry</div>
                <div class="search-result-actions">
                    <button class="btn-retro" onclick="window.loadVideoToDeck('A', '${videoId}', 'Direct Video')">Deck A</button>
                    <button class="btn-retro" onclick="window.loadVideoToDeck('B', '${videoId}', 'Direct Video')">Deck B</button>
                </div>
            </div>
        </div>
    `;
